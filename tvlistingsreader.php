<?php
$str = file_get_contents("http://www.bleb.org/tv/channel.html?ch=bbc1&all");		
file_put_contents("BBC10.html",$str);
$str = file_get_contents("http://www.bleb.org/tv/channel.html?ch=bbc2&all");		
...
$str = file_get_contents("http://www.bleb.org/tv/channel.html?ch=bbc1&all&day=1");		
file_put_contents("BBC13.html",$str);
$str = file_get_contents("http://www.bleb.org/tv/channel.html?ch=bbc2&all&day=1");		
