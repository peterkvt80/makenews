...
$mintemp=100;
writeHeader();
$BE=file_get_html("Belfast(CountyAntrim).html");
$CR=file_get_html("GlamorganC.C.C.(Cardiff).html");
$ED=file_get_html("Edinburgh(Edinburgh).html");
$LO=file_get_html("London(GreaterLondon).html");
